  ...
  return (
    <section className='py-24 relative overflow-hidden' id='venue'>
        ...
        <div className="max-w-5xl mx-auto px-6">
            ...
            {/* Venue Card */}
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-lilac-100">
                ...
                <div className="p-7">
                    ...
                    <p className="font text-babypink-400 text-xs tracking-widest uppercase font-semibold mb-4">Ceremony & Reception</p>
                    <ul className="space-y-3 font text-sm text-gray-600">
                        <li className="flex items-start gap-3"><span className="text-lilac-400 mt-0.5">📍</span>BuckToe Street, Kingston -10</li>
                        <li className="flex items-start gap-3"><span className="text-lilac-400 mt-0.5">🕒</span>Doors open at 2:30 PM</li>
                        <li className="flex items-start gap-3"><span className="text-lilac-400 mt-0.5">🚗</span>Free valet parking available on-site</li>
                        <li className="flex items-start gap-3"><span className="text-lilac-400 mt-0.5">♿</span>Fully accessible venue</li>
                    </ul>
