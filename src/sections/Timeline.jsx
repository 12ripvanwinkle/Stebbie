    ...
    <section className="py-24 relative overflow-hidden" id='timeline'>
        ...
        <div className="max-w-2xl mx-auto px-6">
            <div className="text-center mb-14">
                <p className="font text-white text-xs tracking-widest uppercase font-semibold mb-2">
                    Plan Your Day
                </p>
            ...
            <div className="relative">
                ...
                {timelineItems.map((item, i) => (
                    ...
                    <div className="pt-1">
                        <span className="font text-xs text-violet-100 font-bold tracking-widest uppercase">{item.time}</span>
