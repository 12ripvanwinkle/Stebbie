    ...
    <section className="py-24 overflow-hidden" id='faqs'>
        <div className="max-w-2xl mx-auto px-6">
            <div className="text-center mb-14">
                <p className="text-softserve-100 text-xs tracking-widest uppercase font-semibold mb-2">
                    Good to Know
                </p>
                <h2 className="font text-4xl text-violet-600">
            ...
            <div className="mt-12 text-center">
                <p className="font-sans text-sm text-softserve-100">Still have questions? Email us at <a href="mailto:hello@niteshanthony3@gmail.com" className="text-softserve-100 font-semibold hover:underline">hello@niteshanthony3@gmail.com</a></p>
            </div>
        </div>
    </section>
  )
